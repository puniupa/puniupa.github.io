...
* 本当に時期によってストレス値の中央値が違う可能性がある．
* 職位変更と顧客変更で，ココシルスコアの変化率に違いが見られる可能性がある．
* 「職業性ストレスチェック」は（バイオマーカーなどが反映するような）現実を全く反映していないと思われる．
...
#### 「どれくらい遅れて出るか？」を見たが，ほとんど切片と測定時点で説明してしまい，３ヶ月前の残業時間に関しては負の影響を持っている． {#sec-item-response-to-OT}
