...
#| echo: false
library(brms)
fit_only_FLC_cov <- readRDS("../../../Desktop/Mentalism/3-BayesianDataAnalysis/Cocosiru/rdb/fit_only_FLC_cov.rds")
```
...
#| echo: false
library(brms)
fit_1PL_sub_cov <- readRDS("../../../Desktop/Mentalism/3-BayesianDataAnalysis/Cocosiru/rdb/fit_1PL_sub_cov.rds")
```
